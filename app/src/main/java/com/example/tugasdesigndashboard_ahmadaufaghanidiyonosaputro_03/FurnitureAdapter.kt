...
class FurnitureAdapter(private val context: Context, private val furniture: List<Furniture>, val listener: (Furniture) -> Unit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FurnitureViewHolder {
        return FurnitureViewHolder(
            LayoutInflater.from(context).inflate(R.layout.item_list1, parent, false)
        )
    }
